...
/***/ function(module, exports) {
	...
	var Board = function () {
	  ...
	  _createClass(Board, [{
	    key: "has",
	    value: function has(square) {

	      return square.x <= this.boundaries.x.max && square.x >= this.boundaries.x.min && square.y <= this.boundaries.y.max && square.y >= this.boundaries.y.min;
	    }
	  }]);
